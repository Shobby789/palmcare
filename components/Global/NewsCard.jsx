...
const NewsCard = () => {
  return (
    <div className="flex flex-col relative custom-shadow group bg-white">
      ...
      <div className="w-full p-5 flex flex-col items-start gap-2 relative pt-10">
        ...
        <p className="text-[#3f3f3f] text-[13px]">
          Despite facing significant financial constraints, this organization
          continues
        </p>
        <Link
          href={"/"}
          className="text-[#3f3f3f] text-[13px] font-semibold underline"
        >
          Read more
        </Link>
      </div>
